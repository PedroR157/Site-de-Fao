    ...
    <main>
        <div class="container py-4 ">
            ...
            <div class=" p-5 mb-4 bg-body-tertiary rounded-3">
                <div class="container-fluid custom-bg py-5">
            ...
            <div class="row align-items-md-stretch">
                <div class="col-md-6">
                    <div class="h-100 p-5 custom-bg  rounded-3">
                        <h2 class= "cortexto">Perfil</h2>
                        <p class="cortexto">Este painel é utilizado para destacar que utilizadores REGISTADOS podem alterar o próprio perfil. Aqui
                        ...
                        <a href="/Website/perfil.php"><button class="btn btn-outline-light px-5" type="button">Editar</button></a>
                    </div>
                </div>
                ...
                if (autenticado() && $utilizador['administrador']) {
                    ...
                    <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                        ...
                        <p>Este painel é exclusivo para utilizadores REGISTADOS e que tenham o perfil de ADMINISTRADOR. Aqui você poderá criar,
                            alterar, apagar, promover e despromover outros utilizadores a administradores do sistema, e também poderá alterar as notícias no respectivo painel.</p>
                        <a href="/Painel_Admin/"><button class="btn btn-outline-success" type="button">Administração</button></a>
                    </div>
                </div>';
                }
                ?>
